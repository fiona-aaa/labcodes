...
print_stackframe(void) {
      ...
      */
    uint32_t ebp = read_ebp();//get value of ebp
    uint32_t eip = read_eip();//get value of eip

    for (int i = 0; i < STACKFRAME_DEPTH; i++) {
        // I forgot to judge whether ebp is 0. Add it.
        if(ebp == 0){
            break;
        }
        ...
        cprintf("\n");
        //print C calling function name and line number, etc. 
